...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.eventLoopGuard": "Gateway Event Loop Guard",
  "gateway.eventLoopGuard.enabled": "Gateway Event Loop Guard Enabled",
  "gateway.eventLoopGuard.sampleIntervalMs": "Gateway Event Loop Guard Sample Interval (ms)",
  "gateway.eventLoopGuard.warnLagMs": "Gateway Event Loop Warn Lag (ms)",
  "gateway.eventLoopGuard.severeLagMs": "Gateway Event Loop Severe Lag (ms)",
  "gateway.announceDelivery": "Gateway Announce Delivery",
  "gateway.announceDelivery.maxInBandMs": "Gateway Announce In-Band Max (ms)",
  "gateway.announceDelivery.workerConcurrency": "Gateway Announce Worker Concurrency",
